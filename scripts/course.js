...
function displayCourses(list) {
    ...
    const creditsSum = list.reduce((sum, course) => sum + course.credits, 0);
    
    totalCredits.textContent = `The total credits for courses listed is ${creditsSum}`;
    ...
    list.forEach(course => {
        ...
        certificateSection.appendChild(div);
    });
}
